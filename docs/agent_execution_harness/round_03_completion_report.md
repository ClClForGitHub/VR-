# Codex Completion Report: Round 03 Core Pipeline Semantics
...
scripts/status_runtime_console.sh -> historical service check; current Creator
App frontend/backend contract is 5173 same-origin `/api/creator`.
